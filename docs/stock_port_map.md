...
## Doctype / Small Child Tables

| Source | Target | Status | Notes |
| --- | --- | --- | --- |
| `stock/doctype/item_customer_detail/__init__.py` | `src/erpnext/stock/doctype/item_customer_detail/mod.rs` | parity_tested | Python package marker is empty; Rust exposes the matching Item Customer Detail child-table module. |
| `stock/doctype/item_customer_detail/item_customer_detail.py` | `src/erpnext/stock/doctype/item_customer_detail/item_customer_detail.rs` | parity_tested | Python controller is pass/no-op; Rust preserves child-table metadata, editable-grid, sort order, field-order driven frontend order, customer/customer-group link flags, ref-code required/search/list/filter metadata, oldfield metadata, parent linkage fields from generated type hints, and empty controller hooks. JSON print-width remains metadata/runtime integration. |
| `stock/doctype/item_variant/__init__.py` | `src/erpnext/stock/doctype/item_variant/mod.rs` | parity_tested | Python package marker is empty; Rust exposes the matching Item Variant child-table module. |
| `stock/doctype/item_variant/item_variant.py` | `src/erpnext/stock/doctype/item_variant/item_variant.rs` | parity_tested | Python controller is pass/no-op; Rust preserves child-table metadata, editable-grid, sort order, item attribute link metadata, item attribute value data metadata, parent linkage fields from generated type hints, and empty controller hooks. |
| `stock/doctype/item_website_specification/__init__.py` | `src/erpnext/stock/doctype/item_website_specification/mod.rs` | parity_tested | Python package marker is empty; Rust exposes the matching Item Website Specification child-table module. |
| `stock/doctype/item_website_specification/item_website_specification.py` | `src/erpnext/stock/doctype/item_website_specification/item_website_specification.rs` | parity_tested | Python controller is pass/no-op; Rust preserves child-table metadata, editable-grid, sort order, label/description field metadata, list-view/width flags, parent linkage fields from generated type hints, and empty controller hooks. JSON print-width remains metadata/runtime integration. |
| `stock/doctype/landed_cost_vendor_invoice/__init__.py` | `src/erpnext/stock/doctype/landed_cost_vendor_invoice/mod.rs` | parity_tested | Python package marker is empty; Rust exposes the matching Landed Cost Vendor Invoice child-table module. |
| `stock/doctype/landed_cost_vendor_invoice/landed_cost_vendor_invoice.py` | `src/erpnext/stock/doctype/landed_cost_vendor_invoice/landed_cost_vendor_invoice.rs` | parity_tested | Python controller is pass/no-op; Rust preserves child-table metadata, editable-grid, sort order, vendor invoice link/search/list metadata, amount currency options/read-only/list metadata, parent linkage fields from generated type hints, and empty controller hooks. |
| `stock/doctype/shipment_delivery_note/__init__.py` | `src/erpnext/stock/doctype/shipment_delivery_note/mod.rs` | parity_tested | Python package marker is empty; Rust exposes the matching Shipment Delivery Note child-table module. |
| `stock/doctype/shipment_delivery_note/shipment_delivery_note.py` | `src/erpnext/stock/doctype/shipment_delivery_note/shipment_delivery_note.rs` | parity_tested | Python controller is pass/no-op; Rust preserves child-table metadata, editable-grid, quick-entry, sort order, track-changes, delivery-note required link metadata, value currency read-only/list metadata, parent linkage fields from generated type hints, and empty controller hooks. |
